...
namespace rts
{
    public class SimpleButton : BaseObject
    {
        ...
        public static void UpdateAll(MouseState mouseState, KeyboardState keyboardState)
        {
            ...
            foreach (SimpleButton button in allButtons)
            {
                button.checkForHotKey(keyboardState);
            }
        }

        bool allowHotkey, pressingHotKey;
        void checkForHotKey(KeyboardState keyboardState)
        {
            if (Hotkey == Keys.Sleep)
                return;

            if (keyboardState.IsKeyUp(Hotkey))
            {
                allowHotkey = true;
                pressingHotKey = false;
            }
            else if (allowHotkey && keyboardState.IsKeyDown(Hotkey))
            {
                allowHotkey = false;
        ...
        public static void Reset()
        {
            ...
            foreach (SimpleButton button in allButtons)
            {
                button.allowHotkey = false;
                button.pressingHotKey = false;
            }
        }
        ...
        public bool PressingHotkey
        {
            get
            {
                return pressingHotKey;
            }
        }
