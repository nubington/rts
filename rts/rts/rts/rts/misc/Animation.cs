...
namespace rts
{
    ...
    class UnitAnimation : Animation
    {
        ...
        public UnitAnimation(Unit unit, int size, float duration, bool stayAfterDeath, params Texture2D[] textures)
        ...
        public UnitAnimation(Unit unit, int size, float duration, bool stayAfterDeath, Texture2D spriteSheet, int frameWidth, int frameHeight)
            : base(duration, Util.SplitTexture(spriteSheet, frameWidth, frameHeight))
        {
            Unit = unit;
            Rectangle = new Rectangle(0, 0, size, size);
