...
namespace rts
{
    class BaseObject
    {
        ...
        public virtual Texture2D Texture
        {
            ...
            {
                texture = value;
                textureCenterOrigin = new Vector2(texture.Width / 2, texture.Height / 2);
            }
        }
        ...
        {
            return (point.X >= PreciseX && point.X <= PreciseX + Width &&
                point.Y >= PreciseY && point.Y <= PreciseY + Height);
        }
